...
def title():
    ...
    stdout.write("                                                                                          \n")
    stdout.write("                                                                                          \n")
    stdout.write("                          "+Fore.LIGHTGREEN_EX+"  * 1ucif3r.me *   \n")
    stdout.write("                                                                                          \n")

def command():
    stdout.write("                                                                                          \n")
    stdout.write(Fore.LIGHTYELLOW_EX+"╔══["+Fore.RED+"root"+Fore.LIGHTGREEN_EX+"@"+Fore.RED+"1ucif3r"+Fore.YELLOW+"]"+Fore.LIGHTYELLOW_EX+"\n╚"+Fore.LIGHTYELLOW_EX+"═══➤"+Fore.WHITE)
    command = input()
    if command == "cls":
        clear()
        title()
